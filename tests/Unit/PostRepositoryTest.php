...
class PostRepositoryTest extends TestCase
{
    ...
    // By convention, we use snake_case for method names and prefix it with test_
    public function test_create()
    {
        ...
        $repository = $this->app->make(PostRepository::class); // using the app container to make an instance of PostRepository
